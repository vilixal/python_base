...
for tovar, code in goods.items():
    spisok_sklad = store[code]
    count, price = 0, 0
    for count_sklad in spisok_sklad:
        price += count_sklad['quantity'] * count_sklad['price']
        count += count_sklad['quantity']
    print(tovar, ' - ', count, ' шт, стоимость ', price, ' руб', sep="")
